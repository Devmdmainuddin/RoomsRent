...
const AddRoomForm = ({ handleDates, dates, handleSubmit, setImagePreview, imagePreview,handleImage,imageText }) => {
                ...
                <div className='grid grid-cols-1 lg:grid-cols-2 gap-10'>
                    ...
                    <div className='space-y-6'>
                        ...
                        <div className=' p-4 bg-white w-full  m-auto rounded-lg flex justify-between items-center'>
                            ...
                            <div className="w-16 h-16 object-cover overflow-hidden">
